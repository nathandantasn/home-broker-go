...
type Book struct {
	...
	OrdersChan    chan *Order //Input de orders
	OrdersChanOut chan *Order //Output de orders
	Wg            *sync.WaitGroup
}

func NewBook(orderChan chan *Order, ordersChanOut chan *Order, wg *sync.WaitGroup) *Book {
	return &Book{
		Order:         []*Order{},
		Transactions:  []*Transaction{},
